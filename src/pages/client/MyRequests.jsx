...
function BlockScreen({ lead, providerName, onReleased }) {
  ...
  // Calcular tiempo restante (24h desde unlocked_at o created_at)
...
export default function MyRequests() {
  ...
  const [blockLead, setBlockLead] = useState(null)   // lead por_confirmar activo
    ...
    if (!error) {
      ...
      for (const req of reqs) {
        ...
        if (pendingLead) {
          ...
          // Buscar nombre del proveedor desde offers
  ...
  async function acceptOffer(offer, request) {
    ...
    try {
      ...
      // 5. Crear lead en estado por_confirmar (default de la columna)
  ...
  return (
    <>
      {/* Pantalla de bloqueo si hay lead por_confirmar */}
      {blockLead && (
        <BlockScreen
          lead={blockLead}
